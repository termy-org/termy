use crate::gpui::{FocusHandle, KeyBinding, MenuItem, OsAction, Window};
    ...
    ($namespace:path, [ $( $(#[$attr:meta])* $name:ident),* $(,)? ]) => {
        $(
            ...
            impl $name {
                ...
                fn __autogenerated() {
                    #[doc(hidden)]
                    fn __gpui_action_builder() -> crate::gpui::MacroActionData {
                        crate::gpui::MacroActionData {
                            name: concat!(stringify!($namespace), "::", stringify!($name)),
                            type_id: ::std::any::TypeId::of::<$name>(),
                            build: <$name as crate::gpui::Action>::build,
                            json_schema: <$name as crate::gpui::Action>::action_json_schema,
                            deprecated_aliases: <$name as crate::gpui::Action>::deprecated_aliases(),
                            deprecation_message: <$name as crate::gpui::Action>::deprecation_message(),
                            documentation: <$name as crate::gpui::Action>::documentation(),
                        }
                    }

                    crate::gpui::private::inventory::submit! {
                        crate::gpui::MacroActionBuilder(__gpui_action_builder)
                    }
                }
            }

            impl crate::gpui::Action for $name {
                ...
                fn partial_eq(&self, action: &dyn crate::gpui::Action) -> bool {
                    action
                        .as_any()
                        .downcast_ref::<Self>()
                ...
                fn boxed_clone(&self) -> Box<dyn crate::gpui::Action> {
                    Box::new(self.clone())
                }

                fn build(
                    _value: crate::gpui::private::serde_json::Value,
                ) -> crate::gpui::Result<Box<dyn crate::gpui::Action>> {
                    Ok(Box::new(Self))
                }

                fn action_json_schema(
                    _generator: &mut crate::gpui::private::schemars::SchemaGenerator,
                ) -> Option<crate::gpui::private::schemars::Schema> {
                    None
                }
            }
        )*
