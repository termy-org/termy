...
pub(super) struct TabStripPalette {
    pub(super) tab_stroke_color: crate::gpui::Rgba,
    pub(super) inactive_tab_bg: crate::gpui::Rgba,
    pub(super) active_tab_bg: crate::gpui::Rgba,
    pub(super) hovered_tab_bg: crate::gpui::Rgba,
    pub(super) active_tab_text: crate::gpui::Rgba,
    pub(super) inactive_tab_text: crate::gpui::Rgba,
    pub(super) close_button_bg: crate::gpui::Rgba,
    pub(super) close_button_border: crate::gpui::Rgba,
    pub(super) close_button_hover_bg: crate::gpui::Rgba,
    pub(super) close_button_hover_border: crate::gpui::Rgba,
    pub(super) close_button_hover_text: crate::gpui::Rgba,
    pub(super) switch_hint_bg: crate::gpui::Rgba,
    pub(super) switch_hint_border: crate::gpui::Rgba,
    pub(super) switch_hint_text: crate::gpui::Rgba,
    pub(super) tab_drop_marker_color: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_bg: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_hover_bg: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_border: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_hover_border: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_text: crate::gpui::Rgba,
    pub(super) tabbar_new_tab_hover_text: crate::gpui::Rgba,
}
