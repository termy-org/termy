      ...
      <div className="max-w-4xl mx-auto">
        ...
        {error && (
          <div className="p-6 rounded-xl border border-destructive/50 bg-destructive/10 text-center">
            ...
            <Link to="/releases" className="mt-4 inline-block text-sm text-muted-foreground hover:text-foreground">
              View all releases
            </Link>
          </div>
        )}
          ...
          <>
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <h1 className="text-4xl md:text-5xl font-bold">{release.tag_name}</h1>
              </div>
            ...
            <div className="text-sm text-muted-foreground">
              <p>
                ...
                {classified && (
                  <>
                    macOS: {classified.mac.length} |{" "}
                    Windows: {classified.windows.length} |{" "}
                    Linux: {classified.linux.length}
                  </>
                )}
              </p>
            </div>
