use crate::constants::{
    DEFAULT_CHAT_SIDEBAR_WIDTH, DEFAULT_COLORTERM, DEFAULT_CURSOR_BLINK,
    DEFAULT_INACTIVE_TAB_SCROLLBACK, DEFAULT_MOUSE_SCROLL_MULTIPLIER, DEFAULT_PANE_FOCUS_STRENGTH,
    DEFAULT_SCROLLBACK_HISTORY, DEFAULT_TAB_TITLE_COMMAND_FORMAT,
